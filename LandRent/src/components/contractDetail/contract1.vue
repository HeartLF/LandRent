<template>
  <div>
   <h1><i></i>{{title}}</h1>
   <div class="contract_sample_box"><p style="text-indent:2em;"><strong>发包方：(以下简称甲方)</strong></p>

<p style="text-indent:2em;"><strong>承包方：(以下简称乙方)</strong></p>
...
<p style="text-indent:2em;">二、本合同承包期三十年，自&nbsp;年&nbsp;月&nbsp;日至&nbsp;年&nbsp;月&nbsp;日止。</p>
...
export default {
  ...
  methods: {
    download () {
      window.location.href = 'https://www.tuliu.com/news/index/contractDownload/new_id/48064'
    }
  }
}
</script>
